            ...
            <div className="p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full bg-[#2C2420] text-white py-4 mt-4 uppercase tracking-[0.2em] text-xs font-bold hover:bg-[#4a3e36] transition-all disabled:opacity-50"
                >
...
// ... [REST OF THE FILE REMAINS EXACTLY THE SAME - HeroSection, StorySection, etc.] ...
// To save space, I am not repeating the unmodified sections here, but ensure they are kept as is.
